...
class FluxAndMonoServicesTest {
    ...
    void fruitMonoFlatMapMany() {
        ...
        StepVerifier.create(fruitsFlux).expectNextCount(5).verifyComplete();
    }

    @Test
    void fruitsFluxTransform() {

        var fruitsFlux = fluxAndMonoServices.fruitsFluxTransform(10);
    ...
    void fruitsFluxTransformDefaultIfEmpty() {
        ...
        StepVerifier.create(fruitsFlux).expectNext("Default").verifyComplete();
    }
    ...
    void fruitsFluxTransformSwitchIfEmpty() {
        ...
        StepVerifier.create(fruitsFlux).expectNext("Pineapple", "Jack Fruit").verifyComplete();
    ...
    void fruitsFluxConcat() {
        ...
        StepVerifier.create(fruitsFlux).expectNext("Mango", "Orange", "Tomato", "Lemon").verifyComplete();
    }
    ...
    void fruitsMonoConcatWith() {
        ...
        StepVerifier.create(fruitsFlux).expectNext("Mango", "Tomato").verifyComplete();
    }

    @Test
    void fruitsFluxMerge() {
        var fruitsFlux = fluxAndMonoServices.fruitsFluxMerge().log();
        StepVerifier.create(fruitsFlux).expectNext("Mango", "Tomato", "Orange", "Lemon").verifyComplete();
    }
    ...
    void fruitsFluxZip() {
        ...
        StepVerifier.create(fruitsFlux).expectNext("MangoTomato", "OrangeLemon").verifyComplete();
    }
    ...
    void fruitsFluxZipTuple() {
        ...
        StepVerifier.create(fruitsFlux).expectNext("MangoTomatoPotato", "OrangeLemonBeans").verifyComplete();
    }

    @Test
    void fruitsMonoZipWith() {

        var fruitsFlux = fluxAndMonoServices.fruitsMonoZipWith().log();
        StepVerifier.create(fruitsFlux).expectNext("MangoTomato").verifyComplete();
    }
    ...
    void fruitsFluxOnErrorReturn() {
        ...
        StepVerifier.create(fruitsFlux).expectNext("Apple", "Mango", "Orange").verifyComplete();
    }
    ...
    void fruitsFluxOnErrorContinue() {
        ...
        StepVerifier.create(fruitsFlux).expectNext("APPLE", "ORANGE").verifyComplete();
    }
    ...
    void fruitsFluxOnErrorMap() {
        ...
        StepVerifier.create(fruitsFlux).expectNext("APPLE").expectError(IllegalStateException.class).verify();
    }

    @Test
    void fruitsFluxOnError() {
        var fruitsFlux = fluxAndMonoServices.fruitsFluxOnError().log();

        StepVerifier.create(fruitsFlux).expectNext("APPLE").expectError(RuntimeException.class).verify();
    }
}